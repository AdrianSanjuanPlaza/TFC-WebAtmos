...
router.get("/", jwtMW.authenticate, requireAdmin, requestsController.findAllRequest)
...
router.delete("/:id", jwtMW.authenticate, requireAdmin, requestsController.deleteRequest)
